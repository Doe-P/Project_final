    ...
    async downloadCertificateByNO() {
      if (this.select_NO) {
        ...
        doc
          ...
          .setFontSize(11)
          .text(`ສະມາຊິກຊາວໜຸ່ມໄດ້ຮັບການຍ້ອງຍໍຈາກ:.. ${sign_by[0]}.`, 0.7, 3.3, {
            align: "left",
            maxWidth: "7.5",
          })
          ...
          .text(
            `ຂໍ້ຕົກລົງເລກທີ ${certific_NO[0]}/ຄຊປປລ,ມຊ..ລົງວັນທີ.${dateformat(date[0],"dd/mm/yyyy")}. ມີສະມາຊິກທີໄດ້ຮັບການຍ້ອງຍໍທັງໝົດ: ${amount[0]} ສະຫາຍ`,
            7.1,
            3.9,
            {
              align: "right",
